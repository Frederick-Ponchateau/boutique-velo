		...
		<script src="<?=base_url("master/style-switcher/style.switcher.js")?>"></script>
		...
		<!-- Examples -->
		<script src="<?=base_url("js/examples/examples.header.menu.js")?>"></script>
		<script src="<?=base_url("js/examples/examples.ecommerce.form.js")?>"></script>
		<script src="<?=base_url("js/examples/examples.ecommerce.sidebar.overlay.js")?>"></script>
